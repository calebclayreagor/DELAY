...
- A labeled ``genes x cells`` matrix of normalized expression or accessibility values from the input scRNA-seq dataset (expression) or scATAC-seq dataset (accessibility), respectively
