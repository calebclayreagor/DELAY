...
- A one-column table of known transcription factors (``Gene1``) in the input dataset, required for finetuning and prediction with incomplete, partially-known ground truth networks
