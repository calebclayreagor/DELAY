...
- A two-column table of transcription factors (Gene1) and targets (Gene2) constituting the known ground truth regulatory network (e.g. from cell-type specific ChIP-seq data, recommended)
